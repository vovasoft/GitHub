package com.example.springbootmabatisdemo;


import com.vova.User;
import com.vova.UserMapper;
...
/**
 * @author vova
 * @version Create in 下午9:40 2017/12/24
 */

@RunWith(SpringRunner.class)
@SpringBootTest
public class SpringbootMabatisDemoApplicationTests{
    @Autowired
