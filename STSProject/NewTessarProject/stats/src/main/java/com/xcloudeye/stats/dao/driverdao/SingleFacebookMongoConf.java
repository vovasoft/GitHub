 ...
 * Query the facebook infomation.
 */
public class SingleFacebookMongoConf {
    private static final SingleFacebookMongoConf singleFacebookMongoConf =
            (new ClassPathXmlApplicationContext("classpath:mongo-driver-conf.xml")).getBean("singleFacebookMongoConf", SingleFacebookMongoConf.class);
    ...
    public SingleFacebookMongoConf() {
    }

    public SingleFacebookMongoConf(String host, Integer port, String dbName,
    ...
    public synchronized static SingleFacebookMongoConf getInstance(){
        return singleFacebookMongoConf;
    }
