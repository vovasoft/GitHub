...
public class SingleBsMongoConf {
    private static final SingleBsMongoConf singleBsMongoConf =
            (new ClassPathXmlApplicationContext("classpath:mongo-driver-conf.xml")).getBean("singleBsMongoConf", SingleBsMongoConf.class);
    ...
    public SingleBsMongoConf() {
    }

    public SingleBsMongoConf(String host, Integer port, String dbName,
