...
public class SingleWonMongoConf {
    private static final SingleWonMongoConf singleBsMongoConf =
            (new ClassPathXmlApplicationContext("classpath:mongo-driver-conf.xml")).getBean("singleWonMongoConf", SingleWonMongoConf.class);
    ...
    public SingleWonMongoConf() {
    }

    public SingleWonMongoConf(String host, Integer port, String dbName,
