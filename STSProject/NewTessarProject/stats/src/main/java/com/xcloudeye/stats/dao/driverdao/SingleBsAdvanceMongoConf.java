 ...
 */
public class SingleBsAdvanceMongoConf {
    private static final SingleBsAdvanceMongoConf singleBsMongoConf =
            (new ClassPathXmlApplicationContext("classpath:mongo-driver-conf.xml")).getBean("singleBsAdvanceMongoConf", SingleBsAdvanceMongoConf.class);
    ...
    public SingleBsAdvanceMongoConf() {
    }

    public SingleBsAdvanceMongoConf(String host, Integer port, String dbName,
    ...
    public synchronized static SingleBsAdvanceMongoConf getInstance(){
