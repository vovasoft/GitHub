 ...
 *
 */
public class SingleRepetitiveMongoUser {
    private static final SingleRepetitiveMongoUser singleRepetitiveMongoUser = new SingleRepetitiveMongoUser();
    ...
    private SingleRepetitiveMongoUser() {
    ...
    public synchronized static SingleRepetitiveMongoUser getInstance(){
