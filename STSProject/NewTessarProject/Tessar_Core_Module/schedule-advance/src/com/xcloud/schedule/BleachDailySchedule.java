 ...
 *
 */
public class BleachDailySchedule
{	
	...
	private static final Logger logger = LoggerFactory.getLogger(BleachDailySchedule.class);
   ...
   public static void main( String[] args )
    {
	 ...
	 /**
	  ...
	  public void getBlQuartzByDaily (){
	  	try{
	  	  DateUtil.setBSCurrentTimeSecond();
			int start=DateUtil.getCurrentHourTimeSecond();
	      System.out.println("bleach daily quart start..."+DateUtil.getBscurrentTime());
	      //初始化Dao操作参数
	      initApp();
	      //计算一天的接口 接口数据
	      ...
	      System.out.println("bleach daily quart end..."+DateUtil.getCurrentHourTimeSecond());
