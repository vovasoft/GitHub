 ...
 */
public class SingleRepetitiveMongoConf {

    private static final SingleRepetitiveMongoConf singleRepetitiveMongoConf = new SingleRepetitiveMongoConf();

    private MongoClient active_client = null;
    private MongoDatabase active_mongoDb = null;

    private SingleRepetitiveMongoConf() {
        Element element = this.loadXmlElement(GetConfigUtil.configFile);
        initMongoClient(element);
    }


    public synchronized static SingleRepetitiveMongoConf getInstance() {
