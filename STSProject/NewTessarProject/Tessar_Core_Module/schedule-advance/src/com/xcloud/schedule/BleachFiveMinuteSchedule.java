 ...
 */
public class BleachFiveMinuteSchedule {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BleachFiveMinuteSchedule.class);
  @SuppressWarnings("resource")
  public static void main( String[] args )
  {
     //ApplicationContext context = new ClassPathXmlApplicationContext("/hoursch-conf.xml");
      BleachFiveMinuteSchedule test = new BleachFiveMinuteSchedule();
		test.getBlQuartzByFiveMinutes();
  }
    ...
    public void getBlQuartzByFiveMinutes() {
        try {
            DateUtil.setBSCurrentTimeMinuteSecond();
            Integer start=DateUtil.getBscurrentMinuteTime();
            System.out.println("bleach five quart start..." + DateUtil.getBscurrentMinuteTime());
            //初始化Dao操作参数
            initApp();
            ...
            System.out.println("bleach five quart end..." + DateUtil.getBscurrentMinuteTime());
