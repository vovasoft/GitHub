$(document).ready(function() {
	...
	$("#id_new_user_copy").click(function() {
		showModal();
		workWithExistData('new_user', jsonData);
	});
	$("#id_active_user_copy").click(function() {
		showModal();
		workWithExistData('active_user', jsonData);
	});
	$("#id_payer_copy").click(function() {
		showModal();
		workWithExistData('payer', jsonData);
	});
	$("#id_new_payer").click(function() {
		showModal();
		workWithExistData('new_payer', jsonData);
	});
	// $("#first_payer").click(function() {
	// 	workWithExistData('first_payer', jsonData);
	// });
	$("#id_payed_money").click(function() {
		showModal();
		workWithExistData('income', jsonData);
	});
	$("#id_order_number").click(function() {
		showModal();
		workWithExistData('all_order',jsonData);
	});
