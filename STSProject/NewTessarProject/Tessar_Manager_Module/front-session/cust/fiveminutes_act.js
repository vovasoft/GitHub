...
function setWithData(param, data) {
	...
	var num = detail.length-rindex;
	 if(num!=0){
//      detail.pop();
		detail.length=detail.slice(0,rdetail.length).length;
		console.log("ooo:"+detail.length);
    }
...
//  var path = "http://localhost:8080/app/fiveminutes_act?app=1001&date=1452913200";
