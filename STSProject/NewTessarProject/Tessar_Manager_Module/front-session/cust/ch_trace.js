...
function setData(data){
	...
	"<th style='text-align: center;' id='id_arpu'></th><th style='text-align: center;'id='id_Pay_rate'></th></tr></thead><tbody id='tbody'></tbody>");
...
//	var str = '<tr><td>'+date+'</td>';
	...
	$.each(data.channels, function(index,item) {
		...
		str += '<td style="text-align:center;">'+isZero(parseFloat(item.income/item.new_user).toFixed(2))+'</td>'
		str += '</tr>';
	});
	$("#tbody").html(str);
    getDatatabel();
...
function loadProperties() {
        ...
        jQuery.i18n.properties({
            ...
            callback : function() {
            	...
            	$('#id_Pay_rate').html($.i18n.prop('id_Pay_rate'));
            }
        });
}   	