$(document).ready(function () {
    ...
    $("#id_order").click(function(){
    	tableStr = '<table>';
    	showModal();
        setData('all_order',jsonData);
    });
    $("#id_payed_order_copy").click(function(){
    	tableStr = '<table>';
    	showModal();
        setData('payed_order',jsonData);
    });
    $("#id_dayly_income").click(function(){
    	tableStr = '<table>';
    	showModal();
...
function getData(param) {
    ...
    var path = getServerPath()+"app/pay_trend?app="+id+"&"+"start="+startTime+"&end="+endTime;
	...
	var title;
            switch(param) {
			    ...
			    case 'all_order':
			        ...
			        break
			    case 'payed_order':
			        title = $('#id_payed_order_copy').val();
			        break
			    case 'income':
			        title = $('#id_dayly_income').val();
			        break
    		}
     $('#h2').text(title);
     $('#param').val(param);
...
function loadProperties() {
        ...
        jQuery.i18n.properties({
            ...
            callback : function() {
            	...
            	$('#id_order').val($.i18n.prop('id_order'));
            	$('#id_payed_order_copy').val($.i18n.prop('id_payed_order_copy'));
            	$('#id_dayly_income').val($.i18n.prop('id_dayly_income'));
