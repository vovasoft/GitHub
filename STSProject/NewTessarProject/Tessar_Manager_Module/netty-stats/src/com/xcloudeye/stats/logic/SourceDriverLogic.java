...
public class SourceDriverLogic {
    ...
    public SourceDriverLogic(int appid) {
        ...
        ClassPathXmlApplicationContext ctx2 = new ClassPathXmlApplicationContext("META-INF/redis-conf.xml");
        ...
        while (it.hasNext()) {
            ...
            if (dailyOne != null && !dailyOne.equals(null)) {
                ...
                channels.add(new ChannelTrackChannel(ch, dailyOne.getParent()
                        , dailyOne.getChild(), dailyOne.getSeq(), income, (int) new_user, (int) payer, arppu));
            }
        }
    ...
    public UserQuery getUserQuery(String uidOrName) {
        ...
        if (userLogin == null) {
            ...
            if (user != null) {
                String newCh = getNewCh((String) user.get("channel_from"));
