...
public class StaticValueUtil {
    ...
    public static final int NARUTO_ID = 2001;
    public static final int HEROCARFT_ID = 3001;
    public static final int LEAGUEOFANGELS_ID = 4001;
    public static final int BLEACH_ID=5001;
...
//	public static final String DOWNLOAD_PATH = "/tmp/stats_csv/";
     ...
     */
    public static final String NARUTO_PAY = "wonpay";
    /**
     ...
     */
    public static final String NARUTO_INCOME = "bsincome";
}
