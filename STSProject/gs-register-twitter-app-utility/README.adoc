...
* https://spring.io/guides/gs/accessing-twitter/[Accessing Twitter Data]
* https://spring.io/guides/gs/register-facebook-app/[Registering an Application with Facebook]
